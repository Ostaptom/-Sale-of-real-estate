...
export class FlatListComponent implements OnInit {
  ...
  constructor(private _flatService: FlatService, private _houseService: HouseService, private _activatedRoute: ActivatedRoute) {
    this._activatedRoute.params.subscribe(next => {
      this._houseService.findOne(next['idh']).subscribe(next => {
